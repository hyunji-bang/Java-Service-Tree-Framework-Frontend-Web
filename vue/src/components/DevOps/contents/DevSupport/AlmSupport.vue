<template>
  <div class="conainer">
    ...
    <div class="content-section">
      <ul class="almSupport">
        <AlmSupportListConent
          v-for="(list, idx) in AlmSupportList"
          :key="idx"
          :listData="list"
        />
        <li>
...
import AlmSupportListConent from '@/components/DevOps/contents/DevSupport/component/AlmSupportListConent.vue';
  ...
  content: [
    {
      ...
      bodyLeftText: [
        { text: 'Confluence by 313 DEV GRP', link: 'http://www.313.co.kr/confluence/' },
      ],
      bodyRightText: [
        'Plan & Opnion & Idea',
        'Negotiation',
...
const AlmSupportList = [RequirementListData, DevelopmentListData, OperationListData];
</script>
